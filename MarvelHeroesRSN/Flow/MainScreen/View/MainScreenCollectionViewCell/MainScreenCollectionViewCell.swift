...
final class MainScreenCollectionViewCell: UICollectionViewCell {
	...
	private func configureConstraints() {
		NSLayoutConstraint.activate([
			heroAvatarImageView.topAnchor.constraint(
				equalTo: safeAreaLayoutGuide.topAnchor),
			heroAvatarImageView.rightAnchor.constraint(
				equalTo: safeAreaLayoutGuide.rightAnchor),
			heroAvatarImageView.leftAnchor.constraint(
				equalTo: safeAreaLayoutGuide.leftAnchor),
			heroAvatarImageView.bottomAnchor.constraint(
				equalTo: safeAreaLayoutGuide.bottomAnchor,
				constant: -MainScreenView.heroNameLabelHeight),

			heroNameLabel.topAnchor.constraint(
				equalTo: heroAvatarImageView.bottomAnchor),
			heroNameLabel.rightAnchor.constraint(
				equalTo: safeAreaLayoutGuide.rightAnchor),
			heroNameLabel.leftAnchor.constraint(
				equalTo: safeAreaLayoutGuide.leftAnchor),
			heroNameLabel.bottomAnchor.constraint(
				equalTo: safeAreaLayoutGuide.bottomAnchor)
		])
	}
